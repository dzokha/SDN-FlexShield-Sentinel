...
The extension temporarily processes **in memory only**:
...
- The extension does **not** access background tabs
- No continuous monitoring of browsing behavior
...
All privacy claims are **verifiable through source code inspection**.
...
No updates will introduce data collection **without explicit user awareness**.
